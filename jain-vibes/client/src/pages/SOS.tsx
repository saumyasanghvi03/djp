      ...
      <section className="section-spacing bg-white">
        <div className="container text-center">
          ...
          <button
            ...
            className="w-32 h-32 rounded-full flex items-center justify-center text-5xl font-bold transition-all duration-300 hover:scale-110 shadow-lg mx-auto"
            style={{
              backgroundColor: sosActive ? 'rgb(220, 38, 38)' : 'rgb(115, 55, 55)',
              color: 'white',
            }}
          >
            SOS
          ...
          <p className="mt-6" style={{ color: 'rgb(150, 150, 150)' }}>
            {sosActive ? 'Calming process activated. Follow the steps below.' : 'Tap the button to activate immediate support'}
          </p>
        </div>
      </section>
